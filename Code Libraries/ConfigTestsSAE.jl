...
function RunNLayerReLUSAETest(encoding_layer, layer_size, num_hidden, primary_activation, learning_rates)
    ...
    set_name = string("Iteration2 LTD SAE ", num_hidden, "x", layer_size, "x", encoding_layer, " ", split(string(primary_activation), ".")[2])
...
RunNLayerReLUSAETest(15, 40, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(15, 40, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(15, 40, 3, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(15, 80, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(15, 80, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(15, 80, 3, ReluActivation, (0.05, 0.1))

RunNLayerReLUSAETest(12, 40, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(12, 40, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(12, 40, 3, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(12, 80, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(12, 80, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(12, 80, 3, ReluActivation, (0.05, 0.1))

RunNLayerReLUSAETest(9, 40, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(9, 40, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(9, 40, 3, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(9, 80, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(9, 80, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(9, 80, 3, ReluActivation, (0.05, 0.1))

RunNLayerReLUSAETest(6, 40, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(6, 40, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(6, 40, 3, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(6, 80, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(6, 80, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(6, 80, 3, ReluActivation, (0.05, 0.1))

RunNLayerReLUSAETest(3, 40, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(3, 40, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(3, 40, 3, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(3, 80, 1, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(3, 80, 2, ReluActivation, (0.05, 0.1))
RunNLayerReLUSAETest(3, 80, 3, ReluActivation, (0.05, 0.1))

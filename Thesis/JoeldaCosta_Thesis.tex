...
%	That said, enjoy!
	...
	The \texttt{Main\_Tutorial} module is made available to provide a step by step walkthrough for using the provided libraries. Configurations and methods are detailed for some naive training on an AGL dataset (see Section \ref{dataset_agl}). It should be noted that these are not necessarily the optimal parameter choices possible for this exercise.

...
\begin{document} 
	...
	\subsection{Value of Historical Signal}
	...
	Results for synthetic data were largely the same, which can be seen in Appendix section \ref{results_features_appendix}.

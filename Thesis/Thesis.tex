...
\begin{technicaldoc}
	...
	\begin{itemize} 
		...
		\item[$\bullet$] Decisions around activations, regularization, learning schedules and SAEs
		\item[$\bullet$] Final result set for synthetic data
	\end{itemize}
	
	\paragraph{Critical Decisions and Points of Concern}

	\begin{itemize} 
		\item[$\bullet$] Price predictions appear to be a lagged time series to actual prices
		\item[$\bullet$] Profits from MMS appear to be very low
	...
	\begin{itemize}
		\item[$\bullet$] SAE Improvements
		\item[$\bullet$] ReLU Activation Improvements		
	\end{itemize}	

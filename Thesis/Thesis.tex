...
\paragraph{SAE Activations and Scaling}
...
While previously considered the best approach for training deep neural networks, the methodology of greedy layerwise RBM pre-training for Sigmoid SAE networks (as described in \cite{Hinton2} had detrimental effects on network performance. Configuration7 \ref{config7} for dataset AGL\&ACL \ref{dataset_aglacl}.

...
\begin{technicaldoc}
	...
	\bigskip\large\textbf{3. Future Status and Next Iteration}\bigskip\normalsize
	...
	\paragraph{Iteration Output}

	\begin{itemize} 
		\item[$\bullet$] Split point decision
		\item[$\bullet$] Result set for synthetic data
		\item[$\bullet$] Dissertation skeleton structure
	...
	\begin{itemize} 
		\item[$\bullet$] Price predictions appear to be a lagged time series/matringale

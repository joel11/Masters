...
\begin{figure}[H]
	...
	%\includegraphics[scale=0.28]{images/results/activation/relu_leaky_relu.png}
...
\begin{technicaldoc}
	...
	\newpage
	\paragraph{Removed from Lit Review}
	...
	\subsubsection{Gradient Descent Parallelization}\label{lr_grad_parallel}

...
of trading strategy)} \\\hline
	...
	\newpage\bigskip\large\textbf{6. Points of concern}\bigskip\normalsize
	...
	\begin{itemize}
		...
		\item Final Datasets still need to be chosen
...
\begin{table}[h]
	\begin{tcolorbox}[tabularx*={\arrayrulewidth0.6mm}{X|X|X|X|X},fontupper=\normalsize\sffamily,colback=white!10!white,colframe=black!40!]
		...
		\\\hline
		{3} & {40} & {0.001} & {75.93\%} & {id 253 0.5580}  \\\hline
		{3} & {80} & {0.0001} & {86.8\%} & {id 254 0.6810}  \\\hline
		{6} & {40}   & {0.001} & {67.99\%} & {id 266}  \\\hline
		{6} & {40}   & {0.0001} & {67.83\%} & {id 265}  \\\hline
		{6} & {80}   & {0.001} & {72.86\%} & {id 268}  \\\hline
		{6} & {80}   & {0.0001} & {68.82\%} & {id 267}  \\\hline						
		{9} & {40} & {0.0001} & {54.53\%} & {id256 0.2787}  \\\hline
		{9} & {80}  & {0.0001} & {56.8\%} & {id 258 0.2886}  \\\hline
		{12} & {40} & {0.01} & {39.62\%} & {id 262}  \\\hline
		{12} & {40} & {0.001} & {38.23\%} & {id 260}  \\\hline
		{12} & {80} & {0.0001} & {39.96\%} & {id 261}  \\\hline
		{15} & {80} & {0.01} & {27.85\%} & {id 263}  \\\hline
		{15} & {80} & {0.0001} & {26.03\%} & {id 264}  \\\hline
	\end{tcolorbox}
\end{table} \FloatBarrier

6 and 80 are overfitting
9 and 80 are overfitting
12 and 80 starting to overfit as well
12 and 40 - testing stable, training decreasing 
15 and 80  - testing stable, training decreasing 

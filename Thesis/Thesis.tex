...
The dataset was generate for 5000 steps, and had a 60/40 split for the SAE/SGD training. The within dataset split for training and validation was 80/20. The prior timewindows used were the past 1 and 7 days, and the future window used for prediction was the next 2 days.
...
\begin{itemize}
	\item Learning Rates: 0.01, 0.001, 0.0001	
	\item Weight Initializations: XavierGlorot, He, Hinton, Normal-Uniform
	\item Layer Sizes: 25, 40, 25 x 25, 40 x 40
	\item Encoding Sizes: 2, 4, 6, 8, 10
\end{itemize}

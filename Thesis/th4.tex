...
The calculation of $SR^*$ requires $\mathrm{V}\left[\left\{\widehat{S R}_{k}\right\}\right]$ and  $K$, which are usually unknown on accounts of being meta-research variables which cannot be estimated from the selected strategy.

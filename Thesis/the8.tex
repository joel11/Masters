...
\begin{document} 
	...
	\begin{itemize}
		\item[8] The observed return rate for $t+D$ from all stocks traded at $t$
		\begin{equation}
			\mathbf{A_{t+D}} 
		\end{equation}
		\item [1] The expected return for $t+D$ from all stocks traded at $t$
		\begin{equation}
		\mathbf{E[U_{{t+D}}]} = \sum_{s \in stocks} \mathbf{E[r]}_{s, {t+D}}
		\end{equation}
	...
	\begin{figure}[H]
		...
		\includegraphics[scale=0.35]{images/results/dsr_old/cluster_sr.png} 
		\caption{
	...
	\begin{figure}[H]
		...
		\includegraphics[scale=0.35]{images/results/dsr_old/cluster_oos.png} 
		\caption{
